...
void solve(){
    ...
    // }
    f(i,0,n){
        if(i!=n-1 and (v[i].first>v[i+1].first or v[i].second>v[i+1].second)){
            nah;
            fo;
        }
        if(i!=n-1 and v[i].second<v[i+1].second and v[i].first>=v[i+1].first){
            nah;
            fo;
        }
        if(i!=n-1 and v[i+1].first-v[i].first<v[i+1].second-v[i].second){
            nah;
            fo;
        }
