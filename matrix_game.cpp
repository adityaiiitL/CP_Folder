    ...
    f(i,0,n){
        ...
        f(j,0,m){
            ...
            if(i==0&&j==0){
                ...
                if(a[i+1][j]!=1&&a[i][j+1]!=1&&a[i][j]==0&&a[i][j-1]!=1){
                ...
                if(a[i-1][j]!=1&&a[i][j+1]!=1&&a[i][j]==0&&a[i+1][j]!=1){
                ...
                if(a[i+1][j]!=1&&a[i-1][j]!=1&&a[i][j+1]!=1&&a[i][j-1]!=1&&a[i][j]==0){
