...
vec a,b,c;
lli dp[100001][2][2][2];
lli func(lli i,bool f1,bool f2,bool f3){
    if(i==n)fo 0;
    if(dp[i][f1][f2][f3]!=-1)fo dp[i][f1][f2][f3];
    if(f1){
        fo dp[i][f1][f2][f3]=max(b[i]+func(i+1,0,1,0),c[i]+func(i+1,0,0,1));
    }
    if(f2){
        fo dp[i][f1][f2][f3]=max(a[i]+func(i+1,1,0,0),c[i]+func(i+1,0,0,1));
    }
    if(f3){
        fo dp[i][f1][f2][f3]=max(a[i]+func(i+1,1,0,0),b[i]+func(i+1,0,1,0));
    }
}
void solve(){
    ...
    cout<<max(func(0,1,0,0),max(func(0,0,1,0),func(0,0,0,1)))<<endl;
}
