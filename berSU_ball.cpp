...
lli func(lli i1,lli i2){
    if(i1==n or i2==m)fo 0;
    if(dp[i1][i2]!=-1)fo dp[i1][i2];
    if(v1[i1]==v2[i2] or abs(v1[i1]-v2[i2])==1){
        lli a=1+func(i1+1,i2+1),b=func(i1+1,i2),c=func(i1,i2+1);
        fo dp[i1][i2]=max(a,max(b,c));
    }
    else{
        fo dp[i1][i2]=max(func(i1+1,i2),func(i1,i2+1));
    }
}
void solve(){
