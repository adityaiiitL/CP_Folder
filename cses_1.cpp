...
class segTree
{
    ...
    void update1(lli si,lli ss,lli se,lli qs,lli qe,lli val){
        if(lazy[si]!=0){
            lli dx=lazy[si];
            lazy[si]=0;
            st[si]+=dx*(se-ss+1);
        ...
        lli mid=(ss+se)/2;
        update1(2*si,ss,mid,qs,qe,val);
        update1(2*si+1,mid+1,se,qs,qe,val);
        st[si]=st[2*si]+st[2*si+1];
    }
    void update2(lli si,lli ss,lli se,lli qs,lli qe,lli val){
        if(lazy[si]!=0){
            lli dx=lazy[si];
            lazy[si]=0;
            st[si]=dx*(se-ss+1);
        ...
        lli mid=(ss+se)/2;
        update2(2*si,ss,mid,qs,qe,val);
        update2(2*si+1,mid+1,se,qs,qe,val);
        st[si]=st[2*si]+st[2*si+1];
    }
};
void solve(){
    ...
    {       
        ...
        if(t==1){
            lli l,r,x;
            cin>>l>>r>>x;
            st.update1(1,0,n-1,l-1,r-1,x);
        }
        else if(t==2){
            lli l,r,x;
            cin>>l>>r>>x;
            st.update2(1,0,n-1,l-1,r-1,x);
            st.update1(1,0,n-1,l-1,r-1,0);
        }
        else{
            lli l,r;
            cin>>l>>r;
