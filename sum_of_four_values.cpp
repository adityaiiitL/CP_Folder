...
void solve(){
    ...
    success:
    if(a==-1 or b==-1 or c==-1 or d==-1)cout<<"IMPOSSIBLE"<<endl;
    else{
        lli k1,k2,k3;
        f(i,0,n)if(w[i]==a){cout<<i+1<<' ';k1=i;break;}
        f(i,0,n)if(w[i]==b and k1!=i){cout<<i+1<<' ';k2=i;break;}
        f(i,0,n)if(w[i]==c and k1!=i and k2!=i){cout<<i+1<<' ';k3=i;break;}
        f(i,0,n)if(w[i]==d and k1!=i and k2!=i and k3!=i){cout<<i+1<<' ';break;}
    }
}
